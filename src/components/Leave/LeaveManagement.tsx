    ...
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-900/50 p-3 sm:p-4 md:p-6">
      <div className="max-w-7xl mx-auto space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-8">
                ...
                <Dialog open={showNewRequestDialog} onOpenChange={setShowNewRequestDialog}>
                  <DialogTrigger asChild>
                    <Button 
                      ...
                      className="group relative px-4 sm:px-6 lg:px-10 py-2 sm:py-3 bg-gradient-to-r from-red-500 via-red-600 to-red-700 hover:from-red-600 hover:via-red-700 hover:to-red-800 text-white rounded-xl sm:rounded-2xl lg:rounded-3xl font-bold sm:font-extrabold shadow-lg sm:shadow-xl lg:shadow-2xl shadow-red-500/40 hover:shadow-xl sm:hover:shadow-2xl hover:shadow-red-600/50 transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden border-2 border-red-400/30 hover:border-red-300/50"
                    >
                      {/* Animated background effect */}
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out"></div>

                      {/* Pulsing ring effect */}
                      <div className="absolute inset-0 rounded-xl sm:rounded-2xl lg:rounded-3xl bg-gradient-to-r from-red-400/20 to-red-600/20 opacity-0 group-hover:opacity-100 animate-pulse"></div>

                      <div className="relative flex items-center gap-2 sm:gap-3">
                        {/* Enhanced icon with glow effect */}
                        <div className="relative">
                          <div className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 bg-white/25 backdrop-blur-sm rounded-lg flex items-center justify-center ring-2 ring-white/20 group-hover:ring-white/40 group-hover:bg-white/30 transition-all duration-300 shadow-lg">
                            <Plus className="h-3 w-3 sm:h-4 sm:w-4 group-hover:rotate-90 transition-transform duration-300" />
                        </div>
                          {/* Glow effect */}
                          <div className="absolute inset-0 w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 bg-white/40 rounded-lg blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
                      </div>

                        <span className="text-sm sm:text-base lg:text-lg tracking-wide drop-shadow-sm">
                          <span className="hidden sm:inline">New Request</span>
                          <span className="sm:hidden">New</span>
                        </span>

                        {/* Sparkle effect on hover */}
                        <div className="absolute -top-1 -right-1 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-yellow-300 rounded-full opacity-0 group-hover:opacity-100 animate-ping"></div>
                        <div className="absolute -top-1 -right-1 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-yellow-400 rounded-full opacity-0 group-hover:opacity-100 animate-pulse"></div>
                      </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          <Card className="group border-slate-200 dark:border-slate-700 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
